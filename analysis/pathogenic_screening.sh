...
Data_dir="$HOME/GP2_NBA_fixed"              # Directory containing input genotyped (NeuroBooster array) data
...
# Reaplce PREFIX with the actual name of your cohort/pattern
Base_name="flipped_GP2_merge_PREFIX"

# Input file paths
# Reaplce PREFIX with the actual name of your cohort/pattern
# Put actual name of the master key for "Master_key_file"
Bim_file="$Data_dir/${Base_name}.bim"
Fam_file="$Data_dir/${Base_name}.fam"
Master_key_file="$Data_dir/PREFIX_key.csv"
...
# Reaplce PREFIX with the actual name of your cohort/pattern
PATTERNS="PREFIX_000(00[1-9]|0[1-9][0-9]|[1-5][0-9]{2}|600|601|602|603|604|605|606|607|608|609|610|611|612|613|614|615|616|617|618|619|620|621|622|623|624|625|626|627|628|629|630|631|632|633|634|635|636|637|638|639|640|641|642|643|644|645|646|647|648|649|650|651|652|653|654|655)_s1\.vcf"
